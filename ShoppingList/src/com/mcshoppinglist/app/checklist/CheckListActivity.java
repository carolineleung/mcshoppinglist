...
public class CheckListActivity extends ListActivity {
    ...
    public static final String[] PROJECTION = new String[] { ShoppingItems._ID,
                    ShoppingItems.SHOPPING_LIST_ID, ShoppingItems.SHOPPING_ITEM_ID,
                    ShoppingItems.ITEM, ShoppingItems.CHECKED, ShoppingItems.LABELS,
                    ShoppingItems.ADDITIONAL_NOTES, ShoppingItems.POSITION,
                    ShoppingItems.MODIFIED_DATE };
    ...
    private void addListItemsLabels() {
        Cursor cur = managedQuery(ShoppingItems.CONTENT_URI, PROJECTION, null, null,
    ...
    private void initAutoComplete() {
        Cursor cursor = managedQuery(ShoppingItems.CONTENT_URI, new String[] { ShoppingItems._ID,
                        ShoppingItems.ITEM }, null, null, ShoppingItems.DEFAULT_SORT_ORDER);
