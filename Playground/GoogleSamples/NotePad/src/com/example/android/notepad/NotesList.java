...
/**
 * Displays a list of notes. Will display notes from the {@link Uri} provided in the intent if there is one, otherwise
 * defaults to displaying the contents of the {@link NotePadProvider}
 */
public class NotesList extends ListActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.addIntentOptions(Menu.CATEGORY_ALTERNATIVE, 0, 0, new ComponentName(this, NotesList.class), null, intent,
				0, null);
